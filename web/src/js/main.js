...
TDF.Home = (function() {
	...
	my.base_url = '/';
	my.share_text = "Explorez les #données des 101 Tours de France : tracés, vainqueurs, lieux mythiques... #appli #data #TDF via @RFnvx";
...
TDF.Traces = (function() {
	...
	my.share_text = "Découvrez les tracés des 101 éditions du Tour de France dans une #carte interactive #appli #data #TDF via @RFnvx";
